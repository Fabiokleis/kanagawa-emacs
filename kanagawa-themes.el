...
;;;;;;; lsp-ui
      ...
      (lsp-ui-peek-peek (:background ,bg-m2))
      (lsp-ui-peek-list (:background ,bg-m3))
      (lsp-ui-peek-filename (:foreground ,blue))
      (lsp-ui-peek-line-number (:foreground ,nontext))
      (lsp-ui-peek-highlight (:foreground ,fg :background ,bg-search :box (:line-width -1 :color ,diag-info)))
      (lsp-ui-peek-header (:foreground ,fg :background ,pmenu-bg :bold t))
      (lsp-ui-peek-footer (:inherit lsp-ui-peek-header))
      (lsp-ui-peek-selection (:foreground ,fg :background ,pmenu-bg-sel))
